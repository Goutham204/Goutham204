### Hi, I'm Vishnu Goutham K

AI Engineer based in Dubai, UAE. I work with machine learning, deep learning, computer vision, and NLP, building end-to-end pipelines from data preprocessing to cloud deployment.

### Skills

- **Languages:** Python, SQL
- **ML/DL Frameworks:** TensorFlow, PyTorch, Scikit-learn, Keras, OpenCV, NLTK
- **Cloud & Infrastructure:** AWS Lambda, AWS S3, DynamoDB, CloudFront, API Gateway, ECR, IAM, Docker
...
- Diploma in Artificial Intelligence — Soften Technologies (2023–2024)
- Bachelor of Computer Applications — University of Kerala (2018–2021)
